...
//
#include "practice/practice_chapter_13.h"
void r_file(void){
    int ch;
    FILE * fp,* fo;
    fp = fopen("null.log","r");
...
#define SLEN 81
    FILE *fa, *fs;	// fa for append file, fs for src file
    int files = 0;  // number of files appended
    char file_app[SLEN];  // name of append file
    char file_src[SLEN];  // name of src file
    int ch;
    ...
    puts("Enter name of first src file (empty line to quit):");
